...
int main() {
    ...
    write_file("checkpoint_1.dat", (uint8_t *)run_1.data(), N * sizeof(double));
    write_file("checkpoint_2.dat", (uint8_t *)run_2.data(), N * sizeof(double));
    run_1.clear(); run_2.clear();
    ...
    threaded_cmp_t<double> threaded_cmp("checkpoint_1.dat", "checkpoint_2.dat", offsets, CHUNK_SIZE, ERROR);
