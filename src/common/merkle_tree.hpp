...
class tree_t {
  ...
  public:
    ...
    KOKKOS_FUNCTION HashDigest &operator()(uint32_t i, uint32_t j) const;
    ...
    KOKKOS_FUNCTION uint32_t num_leaf_descendents(uint32_t node,
                                                         uint32_t num_nodes);
    KOKKOS_FUNCTION uint32_t leftmost_leaf(uint32_t node,
                                                  uint32_t num_nodes);
    KOKKOS_FUNCTION uint32_t rightmost_leaf(uint32_t node,
                                                   uint32_t num_nodes);
