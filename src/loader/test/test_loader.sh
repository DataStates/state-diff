...
batch_size=4
max_batch_size=4 #($batch_size * (2**5)) # 5 experiments
outname="test"
...
do
  flags="/data/8gpus/np796-500mil/run1/m000p.mpirestart-combined-0-10.dat -f"
  # flags="test0.dat -u"
  cmd="$BUILD_DIR/src/loader/test/test_loader $host_cache $dev_cache $flags"
